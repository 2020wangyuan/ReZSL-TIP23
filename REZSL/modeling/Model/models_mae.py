...
from REZSL.modeling.Model.utils import get_2d_sincos_pos_embed
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward(self, imgs, mask_one_hot):

        pred = self.forward_decoder(latent, mask_one_hot)  # [N, L, p*p*3]
        loss = self.forward_loss(imgs, pred, mask_one_hot)
        return loss, pred, mask_one_hot


# 恢复图像时，将被遮挡的tokens换成语义信息，引导图像重构
class MaskedAutoencoderViT1(nn.Module):
    """ Masked Autoencoder with VisionTransformer backbone
    """
