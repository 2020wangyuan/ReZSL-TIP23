...
class ViT1(nn.Module):
    def __init__(self, model_name='google/vit-large-patch16-224-in21k', pretrained=True):
        ...
        if model_name == 'google/vit-large-patch16-224-in21k':
            self.vit = ViTModel.from_pretrained("/mnt/mydisk1/wangyuan/project/ReZSL/pretrained_model/VIT/large")
            ...
            self.vit = ViTModel.from_pretrained("/mnt/mydisk1/wangyuan/project/ReZSL/pretrained_model/VIT/base")
